...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.patients.index') }}" class="btn btn-secondary d-flex align-items-center">
            <i class="bi bi-arrow-left-circle me-2"></i> Back to Patients
        </a>
    </div>
    @if ($errors->any())
            ...
            <form action="{{ route('admin.patients.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Patient's given name.</small>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Patient's family name.</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Optional, used for notifications if available.</small>
                    </div>

                    <div class="col-md-6">
                        <label for="phone" class="form-label">Phone</label>
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="Enter phone number" value="{{ old('phone') }}">
                        <small class="text-muted">Optional, e.g., +63 912 345 6789.</small>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <small class="text-muted">Patient's date of birth.</small>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <small class="text-muted">Optional, helps with patient categorization.</small>
                    </div>

                    <div class="col-md-4">
                        <label for="blood_group" class="form-label">Blood Group</label>
                        <input type="text" name="blood_group" id="blood_group" class="form-control" placeholder="e.g., O+, A-" value="{{ old('blood_group') }}">
                        <small class="text-muted">Optional, important for medical emergencies.</small>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <small class="text-muted">Optional, for correspondence or emergency contact.</small>
                </div>
                <div class="mb-3">
                    ...
                    <small class="text-muted">Optional, relevant for treatment decisions.</small>
                </div>
